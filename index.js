...
const closeProductionModalBtn = document.getElementById(
  "close-production-modal-btn"
);
...
fetch(`https://randomuser.me/api/?results=5`, { method: "GET" })
  ...
  .then((data) => {
    ...
    profiles.forEach((person) => {
      ...
      //   crewMember.style.margin = "25px";
      //   crewMember.style.display = "flex";
      //   crewMember.style.flexFlow = "column nowrap";
      //   crewMember.style.padding = "10px";
      //   crewMember.style.textShadow = "1px 1px 1px #000";
      //   crewMember.style.boxShadow = "4px -2px 13px #9e9999";
    });
  });
